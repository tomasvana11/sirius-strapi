...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    HeroBanner: Schema.Attribute.Component<'components.hero-banner', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Category: Schema.Attribute.Enumeration<['novinky', 'vzdelavani']>;
...
export interface ApiBranchBranch extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    clenove_tymu: Schema.Attribute.Relation<
      'oneToOne',
...
export interface ApiCareerBannerCareerBanner extends Struct.SingleTypeSchema {
  collectionName: 'career_banners';
  info: {
    displayName: 'Banner - kari\u00E9ra';
  ...
  attributes: {
    bannerLink: Schema.Attribute.Component<'components.button', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiCareerCareer extends Struct.SingleTypeSchema {
  ...
  attributes: {
    careerAdvantages: Schema.Attribute.Component<
      'components.cards-with-video-section',
      false
    >;
    careerTimeline: Schema.Attribute.Component<
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    DayInSirius: Schema.Attribute.Component<'components.video-section', false>;
    HeroBanner: Schema.Attribute.Component<'components.hero-banner', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiClientClient extends Struct.SingleTypeSchema {
  ...
  info: {
    displayName: 'Str\u00E1nka - Spolupr\u00E1ce';
    pluralName: 'clients';
    singularName: 'client';
  };
  options: {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    servicesSesction: Schema.Attribute.Component<
      'components.services-sesction',
      false
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiCookieCookie extends Struct.SingleTypeSchema {
  ...
  attributes: {
    cookiesContent: Schema.Attribute.Component<'components.text-page', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiGdprGdpr extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    gdprContent: Schema.Attribute.Component<'components.text-page', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    appAdvantages: Schema.Attribute.Component<
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Facts: Schema.Attribute.Component<'components.facts-section', false>;
    HeroBanner: Schema.Attribute.Component<'components.hero-banner', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiKontaktyKontakty extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    CompanyInfo: Schema.Attribute.Component<'components.company-info', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Email: Schema.Attribute.Email;
...
export interface ApiProjektyProjekty extends Struct.SingleTypeSchema {
  collectionName: 'projekties';
  info: {
    displayName: 'Str\u00E1nka - Projekty';
...
export interface ApiTextReferenceTextReference
  extends Struct.CollectionTypeSchema {
  collectionName: 'text_references';
  info: {
    displayName: 'Textov\u00E9 reference';
    pluralName: 'text-references';
    singularName: 'text-reference';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::text-reference.text-reference'
    > &
      Schema.Attribute.Private;
    Name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    yearsBeingClient: Schema.Attribute.Integer;
  };
}
...
export interface ApiTopBarTopBar extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Links: Schema.Attribute.Component<'components.link-with-icon', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::top-bar.top-bar'
...
export interface ApiVideoReferenceVideoReference
  extends Struct.CollectionTypeSchema {
  collectionName: 'video_references';
  info: {
    displayName: 'Video reference';
    pluralName: 'video-references';
    singularName: 'video-reference';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::video-reference.video-reference'
    > &
      Schema.Attribute.Private;
    Name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiWhistleblowingWhistleblowing
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    whistleblowingContent: Schema.Attribute.Component<
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::text-reference.text-reference': ApiTextReferenceTextReference;
      'api::top-bar.top-bar': ApiTopBarTopBar;
      'api::video-reference.video-reference': ApiVideoReferenceVideoReference;
